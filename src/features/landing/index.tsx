...
export default function Landing() {
  ...
  return (
    <>
      <Head title='Landing' description='Discover your dream dog today!'/>
      <Container maxW={'3xl'} className='h-screen flex flex-col justify-center'>
        <Stack as={Box} textAlign={'center'} spacing={{ base: 8, md: 14 }} py={{ base: 20, md: 36 }}>
          ...
          <Text color={'gray.500'}>
            Unlock a world of canine companionship! Sign in now to access advanced filters, personalized recommendations, and connect with your future furry friend. Your perfect
            pup awaits!
          </Text>
